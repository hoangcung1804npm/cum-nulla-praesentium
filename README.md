...
[![testing badge](https://raw.githubusercontent.com/hoangcung1804npm/cum-nulla-praesentium/master/badges/tests-badge.svg?sanitize=true)](badges/tests-badge.svg)
[![coverage badge](https://raw.githubusercontent.com/hoangcung1804npm/cum-nulla-praesentium/master/badges/coverage-badge.svg?sanitize=true)](badges/coverage-badge.svg)

[![Known Vulnerabilities](https://snyk.io/test/github/hoangcung1804npm/cum-nulla-praesentium/badge.svg)](https://snyk.io/test/github/hoangcung1804npm/cum-nulla-praesentium)

<!--[![License](https://img.shields.io/npm/l/JSONPath.svg)](LICENSE-MIT.txt)-->
[![Licenses badge](https://raw.githubusercontent.com/hoangcung1804npm/cum-nulla-praesentium/master/badges/licenses-badge.svg?sanitize=true)](badges/licenses-badge.svg)
...
<small>(see also [licenses for dev. deps.](https://raw.githubusercontent.com/hoangcung1804npm/cum-nulla-praesentium/master/badges/licenses-badge-dev.svg?sanitize=true))</small>
...
`@hoangcung1804npm/cum-nulla-praesentium` expands on the original specification to add some
additional operators and makes explicit some behaviors the original
did not spell out.

Try the [browser demo](https://@hoangcung1804npm/cum-nulla-praesentium.github.io/JSONPath/demo/) or
[Runkit (Node)](https://npm.runkit.com/@hoangcung1804npm/cum-nulla-praesentium).
...
```js
const {JSONPath} = require('@hoangcung1804npm/cum-nulla-praesentium');
...
```html
<script src="node_modules/@hoangcung1804npm/cum-nulla-praesentium/dist/index-browser-umd.cjs"></script>
...
import {
    JSONPath
} from './node_modules/@hoangcung1804npm/cum-nulla-praesentium/dist/index-browser-esm.js';
...
```js
import {JSONPath} from '@hoangcung1804npm/cum-nulla-praesentium';
...
See also the [API docs](https://@hoangcung1804npm/cum-nulla-praesentium.github.io/JSONPath/docs/ts/).
...
A basic command line interface (CLI) is provided. Access it using `npx @hoangcung1804npm/cum-nulla-praesentium <json-file> <jsonpath-query>`.
